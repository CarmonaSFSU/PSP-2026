...
## [*Layout of the RMD Worksheets (this is a header)*]{.underline}
...
1.  Let's import in our dataset into our RStudio session!
    -   Make sure the dataset is in your RStudio project folder, which you can locate through using your Finder (MAC) or File Explorer (PC).

```{r}
ncha_demo <- read.csv("NCHA2021_Session3_5_Subset.csv", col_names = TRUE)
```
